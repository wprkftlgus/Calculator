...
# 🚀 Demo
### 👉 Demo Site : https://sean-calculator.netlify.app

# 🧠 Features

### ✅ Perform basic arithmetic operations: `+`, `-`, `×`, `÷`, `%`  
### ✅ Input validation (prevents multiple operators in a row)  
### ✅ Delete single character (DEL)  
### ✅ Clear all input (AC)  
...
### React Hooks (useState) – Handle calculator input and results
### CSS – Custom styling and layout

# 🎨 UI Components
### Display bar for current input and result
### Numeric buttons (0–9)
### Operator buttons (+, −, ×, ÷, %)
